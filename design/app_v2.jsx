    ...
    <div className="app">
      ...
      <header className="appbar">
        ...
        <div className="appbar-pill">
          <span className="appbar-dot" style={{ background: role === 'internal' ? '#6fd6b8' : '#7cc0d8' }}></span>
          ...
          <>
            ...
            <div className="row gap8" style={{ cursor:'default' }}>
              ...
              <div style={{ lineHeight:1.25 }}>
                <div style={{ fontSize:12, fontWeight:600, color:'#dfeae5' }}>M. Maxwell</div>
                <div style={{ fontSize:10.5, color:'#6a8f85' }}>Methodology key</div>
              </div>
            </div>
          </>
        )}
